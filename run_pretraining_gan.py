...
def get_autoencoder_config(config: configure_pretraining.PretrainingConfig,
  ...
  ae_config.hidden_size = int(round(
      bert_config.hidden_size * config.autoencoder_hidden_size))
  ae_config.num_hidden_layers = int(round(
      bert_config.num_hidden_layers * config.autoencoder_layers))
